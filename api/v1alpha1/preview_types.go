...
type PreviewStatus struct {
	...
	// conditions represent the current state of the Preview resource.
...
type Preview struct {
	...
	// spec defines the desired state of Preview
	// +required
	Spec PreviewSpec `json:"spec"`

	// status defines the observed state of Preview
	// +optional
	Status PreviewStatus `json:"status,omitzero"`
}
