...
export default function DeploymentDetailPage() {
	const { deployment, deploymentId, applicationByID, userByID } =
		useOutletContext<DeploymentDetailContext>();
	const { status, duration, finishedAt, logLines } =
		useWatchDeployment(deploymentId);
	...
	return (
		<>
			<StatusPanel
				...
				finishedAt={
					finishedAt ? formatDateTime(finishedAt) : deployment.finishedAt || "-"
				}
			/>
