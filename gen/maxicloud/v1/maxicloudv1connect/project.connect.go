...
const (
	...
	ProjectServiceName = "maxicloud.v1.ProjectService"
)
...
const (
	...
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/maxicloud.v1.ProjectService/CreateProject"
	// ProjectServiceGetProjectProcedure is the fully-qualified name of the ProjectService's GetProject
	// RPC.
	ProjectServiceGetProjectProcedure = "/maxicloud.v1.ProjectService/GetProject"
	// ProjectServiceListProjectsProcedure is the fully-qualified name of the ProjectService's
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/maxicloud.v1.ProjectService/ListProjects"
	// ProjectServiceUpdateProjectProcedure is the fully-qualified name of the ProjectService's
	// UpdateProject RPC.
	ProjectServiceUpdateProjectProcedure = "/maxicloud.v1.ProjectService/UpdateProject"
	// ProjectServiceDeleteProjectProcedure is the fully-qualified name of the ProjectService's
	// DeleteProject RPC.
	ProjectServiceDeleteProjectProcedure = "/maxicloud.v1.ProjectService/DeleteProject"
)

// ProjectServiceClient is a client for the maxicloud.v1.ProjectService service.
...
// NewProjectServiceClient constructs a client for the maxicloud.v1.ProjectService service. By
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_maxicloud_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// CreateProject calls maxicloud.v1.ProjectService.CreateProject.
...
// GetProject calls maxicloud.v1.ProjectService.GetProject.
...
// ListProjects calls maxicloud.v1.ProjectService.ListProjects.
...
// UpdateProject calls maxicloud.v1.ProjectService.UpdateProject.
...
// DeleteProject calls maxicloud.v1.ProjectService.DeleteProject.
...
// ProjectServiceHandler is an implementation of the maxicloud.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/maxicloud.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *v1.CreateProjectRequest) (*v1.CreateProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("maxicloud.v1.ProjectService.CreateProject is not implemented"))
}

func (UnimplementedProjectServiceHandler) GetProject(context.Context, *v1.GetProjectRequest) (*v1.GetProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("maxicloud.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *v1.ListProjectsRequest) (*v1.ListProjectsResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("maxicloud.v1.ProjectService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) UpdateProject(context.Context, *v1.UpdateProjectRequest) (*v1.UpdateProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("maxicloud.v1.ProjectService.UpdateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) DeleteProject(context.Context, *v1.DeleteProjectRequest) (*v1.DeleteProjectResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("maxicloud.v1.ProjectService.DeleteProject is not implemented"))
}
