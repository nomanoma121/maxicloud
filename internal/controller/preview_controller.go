...
// +kubebuilder:rbac:groups=maxicloud.maximum.vc,resources=previews,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=maxicloud.maximum.vc,resources=previews/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=maxicloud.maximum.vc,resources=previews/finalizers,verbs=update
